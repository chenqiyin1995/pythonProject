...
class site_baseInfo(object):
    def data():
        ...
        data = {
            ...
            "siteType": (random.randint(1, 2)),
            "operation": "I"
        }
        return data

    def api(data):
        url = do_conf('URL_api', 'Host_Url') + '/api/v1/site/baseInfo'
        method = 'POST'
        headers = {
...
if __name__ == '__main__':
    data = site_baseInfo.data()
    test = decrypt.decrypt_api(data=data)
    test = site_baseInfo.api(test)
