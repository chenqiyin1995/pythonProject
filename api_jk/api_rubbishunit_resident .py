...
class Resident(object):
    def data():
        ...
        data = {
            ...
            "residentName": "residentName"+str(random.randint(1,100000)),
            "residentMobile": "166" + str(random.randint(10000000, 99999999)),
            "roomCode": "330106000000" + str(random.randint(100000, 999999)),
    ...
    def api(data):
        url = do_conf('URL_api', 'Host_Url') + '/api/v1/rubbishunit/resident'
        method = 'POST'
        headers = {
