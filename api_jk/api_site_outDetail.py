...
class site_outDetail(object):
    def data():
        ...
        data = {
            ...
            "outTime": Random_time.get_random_time(),
            "photo": "-",
            "operation": "I"
        }
        return data
    ...
    def api(data):
        url = do_conf('URL_api', 'Host_Url') + '/api/v1/site/outDetail'
        method = 'POST'
        headers = {
...
if __name__ == '__main__':
    data = site_outDetail.data()
    test = decrypt.decrypt_api(data=data)
    test = site_outDetail.api(test)
