...
class setpoint_transferDetail(object):
    def data():
        # 请求参数
        data = {
    ...
    def api(data):
        url = do_conf('URL_api', 'Host_Url') + '/api/v1/setpoint/transferDetail'
        method = 'POST'
        headers = {
...
if __name__ == '__main__':
    data = setpoint_transferDetail.data()
    test = decrypt.decrypt_api(data=data)
    test = setpoint_transferDetail.api(test)
