...
class Point_clearjob(object):
    def data():
        ...
        data = {
            ...
            "clearTime": Random_time.get_random_time(),
            "operation": "I"
        }
        return data

    def api(data):
        url = do_conf('URL_api', 'Host_Url') + '/api/v1/point/clearjob'
        method = 'POST'
        headers = {
...
if __name__ == '__main__':
    data = Point_clearjob.data()
    test = decrypt.decrypt_api(data=data)
    test = Point_clearjob.api(test)
